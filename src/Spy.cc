...
int emu::ldaq::reader::Spy::readDDU(uint16_t*& buf) {
  std::cout<<"[readDDU] start"<<std::endl;
...
//-------------------------------------------------------------------//
  ...
  //std::cout<<"buf_start: "<<buf_start<<std::endl;
  std::cout<<"BIGPHYS_PAGES_2: "<<BIGPHYS_PAGES_2<<std::endl;
  std::cout<<"PAGE_SIZE: "<<PAGE_SIZE<<std::endl;
  std::cout<<"TAILPOS: "<<TAILPOS<<std::endl;

  std::cout<<"[readDDU] start while loop"<<std::endl;
  while (true){
...
//       // END DEBUG
  ...
  std::cout<<"[readDDU] end while loop"<<std::endl;
